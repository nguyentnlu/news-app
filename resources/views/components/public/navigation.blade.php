    ...
    <div class="collapse navbar-collapse row" id="navbarSupportedContent">
        <div class="col-sm-6">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('public.home') }}">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
                        ...
                        <a class="dropdown-item" href="{{ route('public.category.index', $menu) }}">{{ $menu->name }}</a>
                        @endforeach
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('public.tag') }}">Tags <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('public.contact') }}">Contact <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
