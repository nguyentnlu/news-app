    ...
    <div class="row mx-0">
            <div class="row">
                ...
                <div class="col-md-3 col-3 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="{{ asset('storage/'.$article->url) }}" alt="{{ $article->url }}" />
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><i class="fa fa-clock-o"></i>{{ $article->created_at }}</div>
                            <div class=""><a href="single.html" class="fh5co_good_font_2">{{ $article->title }}</a></div>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    ...
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="/article/{{ $article->id }}" class="text-white">{{ $article->title }}
                        </a>
